    ...
    public void start(Stage stage) throws IOException {
        ...
        btncrear.setOnAction(e -> {
                ...
                if (!valorNombre.isEmpty() && !valorApellido.isEmpty() && !valorEdad.isEmpty() && rol != null) {
                    ...
                    resultado.setStyle("-fx-background-color: #ffc2c2;");
                    resultado.setText("NO DEBES  DEJAR NINGUNA CAMPO VACIO por favor.");
                }
            });
        ...
        Image image = new Image(getClass().getResourceAsStream("/imagenes/FORMULARIO.png"));
        stage.getIcons().add(image);


        Scene scene = new Scene(grid, 350, 240);
        stage.setTitle("FOMULARIO DIAZ HERNANDEZ DAVID ELIAQUIM");
